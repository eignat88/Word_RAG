...
CREATE INDEX IF NOT EXISTS fd_documents_fd_number_idx ON ai.fd_documents(fd_number);
CREATE INDEX IF NOT EXISTS fd_chunks_section_idx ON ai.fd_chunks(section);
